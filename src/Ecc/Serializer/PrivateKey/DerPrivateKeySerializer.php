...
use Gluwa\Ecc\Serializer\PublicKey\PemPublicKeySerializer;
...
class DerPrivateKeySerializer implements PrivateKeySerializerInterface
{
    ...
    /**
     * {@inheritDoc}
     * @see \Gluwa\Ecc\Serializer\PrivateKeySerializerInterface::serialize()
     */
     ...
     * @param string $data
     * {@inheritDoc}
     * @see \Gluwa\Ecc\Serializer\PrivateKeySerializerInterface::parse()
