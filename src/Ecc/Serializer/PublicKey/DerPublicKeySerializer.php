...
namespace Gluwa\Ecc\Serializer\PublicKey;

use Gluwa\Ecc\Crypto\Key\PublicKeyInterface;
use Gluwa\Ecc\Math\GmpMathInterface;
use Gluwa\Ecc\Math\MathAdapterFactory;
use Gluwa\Ecc\Serializer\PublicKey\Der\Formatter;
use Gluwa\Ecc\Serializer\PublicKey\Der\Parser;
...
class DerPublicKeySerializer implements PublicKeySerializerInterface
{
    ...
    /**
     * {@inheritDoc}
     * @see \Gluwa\Ecc\Serializer\PublicKey\PublicKeySerializerInterface::parse()
     */
